...
% boundaryA_IDs = intersect(intersect(regionA_IDs,gIDmat(boundary)),commonRegion_IDs);
% boundaryB_IDs = intersect(intersect(regionB_IDs,gIDmat(boundary)),commonRegion_IDs);
...
%             boundaryA_IDs = intersect(intersect(regionA_IDs,gIDmat(newBoundary)),commonRegion_IDs);
%             boundaryB_IDs = intersect(intersect(regionB_IDs,gIDmat(newBoundary)),commonRegion_IDs);
